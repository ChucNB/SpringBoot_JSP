...
<div class="container-fluid">
    ...
    <div class="card col-4 m-auto mt-5">
        <div class="card-header">
            Thêm mới
            <a href="/admin/quan-ly-kich-thuoc/index" class="btn btn-primary float-end"><< Quay lại</a>
        </div>
        <div class="card-body row">
            <div class="col-8 m-auto">

                <sf:form modelAttribute="obj"  action="/admin/quan-ly-kich-thuoc/store" method="post">
                    <div class="mt-3">
